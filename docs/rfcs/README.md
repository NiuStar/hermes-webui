...
- [`segmented-session-sidecars.md`](segmented-session-sidecars.md) — implemented
  authority, recovery, bounded-index, compression-segmentation, pagination, and
  rollback contract for very large WebUI conversation histories.
