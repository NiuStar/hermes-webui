...
const APP_TITLEBAR_KEYS = {
  chat: 'tab_chat', tasks: 'tab_tasks', applications: 'Applications', skills: 'tab_skills',
  memory: 'tab_memory', workspaces: 'tab_workspaces',
  profiles: 'tab_profiles', todos: 'tab_todos', insights: 'tab_insights', logs: 'tab_logs', settings: 'tab_settings',
};
const MAIN_VIEW_PANELS = ['settings','skills','memory','tasks','applications','kanban','workspaces','profiles','insights','logs','plugin'];
...
async function switchPanel(name, opts = {}) {
  ...
  if (nextPanel === 'applications') { syncApplicationFields(); await loadApplicationCapabilities(); await loadApplicationTasks(); }
